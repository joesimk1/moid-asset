            ...
            <div class="tab-pane  active" id="new-tab-pane" role="tabpanel">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <form class="mt-8" action="{{ route('assets.update',$asset->id)}}" method="POST">
                            @csrf
                                    ...
                                    <select name="category_id"
                                        ...
                                        @foreach($assetcategories as $assetcategory)
                                            <option value="{{$assetcategory->id}}"
                                                {{old('category_id') == $assetcategory->id || $asset->category_id == $assetcategory->id ? "selected" : ""}}>{{$assetcategory->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                    <div class="invalid-feedback">
                            ...
                            <div class="row mb-3 ">
                                ...
                                <div class="col-sm-10 has-validation">
                                    <select name="depreciation_method"
                                        ...
                                        <option value="">-- Select Category --</option>
                                        <option
                                            value="straight line" {{(old('depreciation_method') == "straight line" || $asset->depreciation_method == "straight line") ? "selected" : ""}}>
                                            Straight Line
                                        </option>
                                        <option
                                            value="declining balance" {{(old('depreciation_method') == "declining balance" || $asset->depreciation_method == "declining balance") ? "selected" : ""}}>
                                            Declining Balance
                                        </option>
                                    </select>
